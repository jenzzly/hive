...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    occupied: 'Occupied', perMonth: '/month', bookProperty: 'Reserve this Property',
    loginToBook: 'Sign in to reserve', contactOwner: 'Contact Owner',
    ...
    bookingRequest: 'Reserve / Rent this Property',
    bookingMessage: 'Tell the owner why you want to reserve this property...',
    submitBooking: 'Submit Reservation Request', bookingSuccess: 'Reservation request sent!',
  ...
  fr: {
    ...
    bookingMessage: 'Dites au propriétaire pourquoi vous souhaitez réserver ce bien...',
    submitBooking: 'Envoyer la demande de réservation', bookingSuccess: 'Demande de réservation envoyée !',
